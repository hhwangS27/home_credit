...
def model_tuning_prepare():
    ...
    credit_model = credit_pipeline.fit(ready_train.na.fill(-999999999))
    ...
    ready_train.write.csv('/user/honghuiw/prepared_for_tuning/', mode='overwrite',header= True)


if __name__ == '__main__':

    model_tuning_prepare()
